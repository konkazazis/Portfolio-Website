                ...
                <tbody class="divide-y divide-zinc-50 dark:divide-zinc-800">
                    @foreach($categories as $category)
                        <tr class="hover:bg-zinc-50/50 dark:hover:bg-zinc-800/30 transition-colors">
                            ...
                            <td class="px-4 py-4 text-zinc-400 dark:text-zinc-500 text-xs font-mono">{{ $category->slug }}</td>
                            <td class="px-4 py-4 text-zinc-600 dark:text-zinc-300">{{ $category->posts_count }}</td>
                            <td class="px-6 py-4">
