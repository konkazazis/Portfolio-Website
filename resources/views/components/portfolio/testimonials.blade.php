        ...
        <div class="space-y-16">
            <div class="border-l-4 border-stone-400 pl-8">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <h5 class="font-sans font-bold text-stone-900">Sarah M.</h5>
            ...
            <div class="border-l-4 border-stone-400 pl-8">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <h5 class="font-sans font-bold text-stone-900">Kostas Kapratsis</h5>
            ...
            <div class="border-l-4 border-stone-400 pl-8">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <h5 class="font-sans font-bold text-stone-900">Christos Karpos</h5>
